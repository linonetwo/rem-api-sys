use crate::{bindings::*, spi_wrapper::{CThostFtdcTraderSpiTrait, C_THOST_FTDC_TRADER_SPI_VTABLE}};
...
impl CThostFtdcTraderApi {
    ...
    pub fn register_spi(&mut self, p_spi: *const dyn CThostFtdcTraderSpiTrait) -> () {
        let p_spi = Box::into_raw(Box::new(( &C_THOST_FTDC_TRADER_SPI_VTABLE, p_spi)));            
        unsafe {
            ((*(*self).vtable_).CThostFtdcTraderApi_RegisterSpi)(self as *mut CThostFtdcTraderApi, p_spi as * mut CThostFtdcTraderSpi)
        }
    }
