...
/// 非法的密码，目前至少8位&&是数字加字母的组合，此外只允许有英文下划线
#define INVALID_PASSWORD_ERROR		10

/// 调用一次下多个订单式，订单数量错误，必须在1-16之间，或者批量撤单，必须在1-37之间
...
/// 在UDP模式下，使用了EnterMultiOrders或者EnterMultiCxlOrders接口，该接口只能在TCP下使用
#define ENTER_MULTI_ORDER_BY_UDP	17

///< 交易所代码错误，范围为100-108
#define INVALID_EXCHANGE_ID	        18

///< 连接服务失败,不是UDP方式连接
#define CONN_NOT_UDP	        19

///< 使用裸协议了，api发单被禁止
#define USE_MIX_PROTOCOL			20
